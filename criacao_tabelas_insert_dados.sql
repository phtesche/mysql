...
ID_VENDEDOR int(4) AUTO_INCREMENT,
...
INSERT INTO `db_dev`.`vendedores`
(`ID_VENDEDOR`,`COD_VENDEDOR`,`NOME`,`DOCUMENTO`,`DATA_CAT`)
VALUES
(1,'632','Marli Esther Martins','883.147.596-78', '2020-03-20'),
(2,'633','Jennifer Bruna Pereira','013.118.013-40', '2020-03-20'),
(3,'634','Nicolas Antonio das Neves','916.446.467-90', '2020-03-20'),
(4,'635','Henrique Peixoto','324.349.941-05', '2020-03-20');
